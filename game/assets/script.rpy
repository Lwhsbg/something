...
label machine_corners:
    ...
    "{i}(July 11, 2023), 'I have located the core. But this damn Artificial Being holding me back from retrieving it, Are they intertwined or something?'{/i}"
    m "{i}Artificial Being?{/i}"
    "{i}Your head suddenly spikes with pain, making you nearly black out{/i}"
    m "What just happened?..."
    "{i}You felt a surge of memories which immediately vanished in a second.{/i}"
    m "Ouch..why did that feel so familiar..Aria?? Was her name Aria?"
    "{i}You get a sudden gust of realization...{/i}"
    m "She never told me her name while introducing herself in the loops except the last one..."
    m "Just what was that, the behavioral patterns, the name, the voice, the happenings, everything was upside down.{/i}"
    m "{i}Wait... Theres some more pages on the diary.{/i}"
    "{i}(October 29, 2023),  I finally neutralized the meddling bug, even though it took a bit of time. It could not be completely erased though. It will be enough for now.{/i}"
    m "Is the bug he talking about??"
    "{i}(March 29, 2024), I finally made something out of the core. I need to work on its conciousness and intellect now.{/i}"
    "{i}(August 23, 2024), There is only one way for it to give rational emotions. My ultimate creation.{/i}"
    "{i}(September 3, 2024), Things are going smoothly. It might take a year or two, but I will survive till then.{/i}"
    "{i}(October 1, 2024), I have started working on the machine. The parts have come around now and it will be running."
    "{i}(November 11, 2025),It has been a year now and the machine is 80 percent done. This core will pobably take ayear more."
    "{i}(December 21, 2025), This chip assistant is acting up, still it is running so i will let it be."
    m "So there was actually something wrong with the device on the last attempt. Oh there is an entry from yesterday."
    "{i}(December 22, 2025), I need to keep this thing on bay and finish the machine as fast as I can.{/i}"
    "{i}This is a pain in the ass. I will modify the core so that it can shut down until I finish.{/i}"
    m "So this guy wants to use my core and become immortal. And there is this mysterious wentity helping me.{/i}"
    m "I need to find out about the mysterious voice. What had it hinted me again?"
    "{i}Pillars on the foundation of earth, four ends of light, where I lay waiting for you.{/i}"
    m "Where I lay waiting for you?"
    m "Looks like Aria tried to act as if she was the original ai but looks like she failed and got destroyed."
